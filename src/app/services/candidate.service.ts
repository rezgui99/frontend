...
export class CandidateService {
  ...
  // === CANDIDATURES ===
  applyToJobOffer(applicationData: JobApplicationRequest): Observable<{ message: string; application: Application }> {
  ...
  // === OFFRES PUBLIQUES ===
  getPublicJobOffers(filters?: JobOfferFilters): Observable<PublicJobOffersResponse> {
    let params = new HttpParams();
    ...
    return this.http.get<PublicJobOffersResponse>(`${this.apiUrl}/public/job-offers`, { params });
  }
