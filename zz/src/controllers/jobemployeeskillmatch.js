...
const JobEmployeeSkillMatch = async (req, res) => {
  ...
  try {
    ...
    // Récupérer les employés avec leurs compétences
    ...
    // Créer un mapping skill -> employés
    ...
    // Identifier les employés qui ont au moins une compétence requise
    ...
    // Récupérer les employés correspondants avec leurs compétences
